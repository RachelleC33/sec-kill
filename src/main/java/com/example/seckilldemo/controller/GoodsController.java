...
public class GoodsController {
    ...
    /**
     * 跳转登录页 *
     * windows 优化前QPS 1332       10000线程 测三次
     * windows 缓存QPS 2342       10000线程 测三次
     * Linux 优化前 QPS 207        10000线程 测三次
     *
     *
     *
     * @return */
    ...
    @ResponseBody
    public String toList( Model model, User user, HttpServletRequest request, HttpServletResponse
            response) {
...
//    @ResponseBody
//    public String toDetail(Model model, User user, @PathVariable Long goodsId,  HttpServletRequest request, HttpServletResponse
//            response) {
//        ValueOperations valueOperations = redisTemplate.opsForValue();
